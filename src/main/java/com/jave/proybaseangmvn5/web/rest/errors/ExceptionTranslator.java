package com.jave.proybaseangmvn5.web.rest.errors;
...
public class ExceptionTranslator extends ResponseEntityExceptionHandler {
    ...
    private ProblemDetailWithCause getProblemDetailWithCause(Throwable ex) {
        if (ex instanceof com.jave.proybaseangmvn5.service.EmailAlreadyUsedException) return new EmailAlreadyUsedException()
            .getProblemDetailWithCause();
        if (ex instanceof com.jave.proybaseangmvn5.service.UsernameAlreadyUsedException) return new LoginAlreadyUsedException()
            .getProblemDetailWithCause();
        if (
            ex instanceof com.jave.proybaseangmvn5.service.InvalidPasswordException
